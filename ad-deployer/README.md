...
./deploy-ad.sh -t 192.168.1.10 -p 'AdminP@ss!' -s 'DsrmP@ss!' -d lab.local -n LAB
```
...
- 🔒 Protection des credentials (LSASS)
...
Les mots de passe doivent respecter la complexité Windows :
